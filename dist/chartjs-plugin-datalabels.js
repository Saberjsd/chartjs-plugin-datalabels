...
helpers$1.merge(Label.prototype, {
  /**
   * @private
   */
  _modelize: function(display, lines, config, context) {
    ...
    return {
      ...
      padding: helpers$1.toPadding(resolve([config.padding, 0], context, index)),
  ...
  update: function(context) {
    ...
    var display = helpers$1.resolve([config.display, true], context, index);
...
helpers$2.merge(HitBox.prototype, {
  center: function() {
    var r = this._rect;
    return {
      x: r.x + r.w / 2,
